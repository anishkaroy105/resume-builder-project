...
export const uploadResume = async (req, res) => {
    try {
        ...
        Provide data in the following JSON format with no additional text before or after. Use actual string values, not schema definitions:

        {
        "professional_summary": "string value here",
        "skills": ["skill1", "skill2", "skill3"],
        "personal_info": {
            "image": "",
            "full_name": "string value here",
            "profession": "string value here",
            "email": "string value here",
            "phone": "string value here",
            "location": "string value here",
            "linkedin": "string value here",
            "website": "string value here"
        },
        "experience": [
            {
                "company": "string value here",
                "position": "string value here",
        ...
        "education": [
            {
                "institution": "string value here",
                "degree": "string value here",
                "field": "string value here",
                "graduation_date": "string value here",
                "gpa": "string value here"
            }
        ]
        }
        `;
